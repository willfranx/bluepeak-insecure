...
('Ahmed', 'ahmed@example.com', 'Austin123'),
('Chris', 'chris@example.com', '!Portland!'),
('Keegan', 'keegan@example.com', 'Pitt5burgh'),
('William', 'william@example.com', 'Anchorage321'),
('Aswin', 'aswin@example.com', '123')
;
